...
const Header = ({ onMenuClick, isMobile }) => {
    ...
    return (
        <header className="bg-white/80 backdrop-blur-xl border-b border-gray-200/50 px-6 py-4 sticky top-0 z-30 shadow-lg rounded-b-xl border-4 border-red-500">
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-6">
                    ...
                    <div className='flex items-center'>
                        <img src="https://metafutureservices.com/assets/newlogo-pZQDBaKP.jpg" className='w-10 mr-1' alt="" />
            ...
            `}>
                            <Search className="absolute text-sm left-4 top-1/2 transform -translate-y-1/2 text-gray-400" size={20} />
                            <input
                                type="text"
                                placeholder="Search transactions, users..."
                                className="w-full pl-12 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-300"
                ...
                <div className="flex items-center space-x-4">
                    ...
                    {/* Join Product Button */}
                    <button className="relative bg-gradient-to-r from-green-600 to-green-500 text-sm text-white px-4 py-2 rounded-xl font-medium hover:from-green-700 hover:to-green-600 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-green-500/25 group overflow-hidden">
                    ...
                    <div className="relative">
                        <button
                            ...
                            className="flex items-center space-x-2 text-xs bg-gradient-to-r from-gray-900 to-gray-800 text-white px-4 py-2 rounded-2xl hover:from-gray-800 hover:to-gray-700 transition-all duration-300 hover:scale-105 group"
                        >
                            <div className="w-6 h-6 rounded-xl bg-gradient-to-br from-green-400 to-blue-500 flex items-center justify-center">
                                <User size={16} className="text-white" />
                            </div>
                            <span className="font-medium">FUTURE TRADE</span>
