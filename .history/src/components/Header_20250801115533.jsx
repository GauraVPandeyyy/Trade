        ...
        <header className="bg-white/80 backdrop-blur-xl border-b border-gray-200/50 px-6 py-4 sticky top-0 z-30">
            ...
            `}>
                ...
                <div className="flex items-center space-x-4">
                    ...
                    {/* Join Product Button */}
                    <button className="relative bg-gradient-to-r from-green-600 to-green-500 text-white tetx px-4 py-3 rounded-2xl font-medium hover:from-green-700 hover:to-green-600 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-green-500/25 group overflow-hidden">
