        ...
        <header className="bg-white backdrop-blur-xl rounded-b-xl border-gray-400 px-6 py-4 sticky top-0 z-30 shadow-lg">
            ...
            `}>
                ...
                <div className="flex items-center space-x-4">
                    ...
                    {/* Join Product Button */}
                    <button className="relative bg-gradient-to-br from-green-300 to-blue-400 text-sm text-white px-4 py-2 rounded-lg font-medium hover:from-green-700 hover:to-blue-200 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-green-500/25 group overflow-hidden">
