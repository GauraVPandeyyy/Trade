...
const AddProduct = ({ open, onClose, walletBalance = 0 }) => {
  ...
  return (
    <div className="absolute top-10 -right-10 bg-black/30 flex items-center justify-center z-[99]">
      <div className="bg-[#222836] relative w-full mx-auto p-7 rounded-3xl shadow-xl text-white animate-fadeIn">
        {/* Close icon */}
        <button
          aria-label="Close"
          onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            >
              ...
              <option value="Scheme B">18 Mnth</option>
              {/* ...More as needed */}
            </select>
