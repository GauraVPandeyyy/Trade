            ...
            `}>
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <div className="relative">
                        ...
                        >
                            <div className="w-7 h-7 p-0 bg-gradient-to-br from-green-400 to-blue-500 rounded-xl flex items-center justify-center">
                                <User size={16} className="text-white p-0 m-0" />
                            </div>
