  ...
  `}
        ...
        >
            <div className='w-full relative bg-gradient-to-br from-gray-800 to-gray-900 p-5 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-700'>
                {/* Badge */}
                {planType !== "Lifetime" ? (<div className='absolute -top-3 -right-3 bg-gradient-to-r from-yellow-400 to-yellow-500 text-gray-900 font-bold px-3 py-1 rounded-full text-sm'>
                    {plan}
                </div>
