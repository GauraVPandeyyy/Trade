...
const DashboardCard = ({ icon: Icon, label, value, colorClass = "text-blue-600", trend, delay = 0 }) => {
  ...
  return (
    ...
    <div
      className={`
    relative w-64 h-auto border-t-4 rounded-2xl p-6 overflow-hidden
    bg-white  border-t-blue-300
    shadow-[0_8px_24px_rgba(0,0,0,0.15)] hover:shadow-[0_12px_32px_rgba(0,0,0,0.1)]
