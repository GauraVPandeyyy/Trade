...
const AddProduct = ({ open, onClose, walletBalance = 0 }) => {
  ...
  return (
    <div className="fixed top-0 right-0 left-0 w-full bg-black/50 backdrop-blur-sm flex items-center justify-center z-[9999] px-4 py-0 overflow-auto">
      <div className="bg-gradient-to-br from-[#1a2035] to-[#0f1324] relative w-fu md:min-w-lg mx-auto p-6 rounded-2xl shadow-2xl border border-[#2a3245] animate-fade-in-up overflow-auto">
        {/* Close button */}
        <button
          onClick={onClose}
