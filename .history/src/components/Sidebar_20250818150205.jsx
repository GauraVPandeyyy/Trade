...
import SidebarLogo from '../assets/outer_logo-CnpqYOqg.png'
const Sidebar = ({ isOpen, onClose, isMobile }) => {
  ...
  return (
    <>
      ...
      `}>
        {/* Logo Section */}
        <div class="py-2 px-4 border-b border-gray-700/50 relative overflow-hidden"><div class="absolute inset-0 bg-gradient-to-r from-green-600/10 to-blue-600/10"></div><div class="relative flex items-center justify-center"><img alt="" class="w-42 animate-pulse" src="/src/assets/outer_logo-CnpqYOqg.png"></div></div>
