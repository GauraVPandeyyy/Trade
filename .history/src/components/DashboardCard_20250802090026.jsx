...
const DashboardCard = ({ icon: Icon, label, value, colorClass = "text-blue-600", trend, delay = 0 }) => {
  ...
  return (
    ...
    <div 
  className={`
    relative w-64 h-48 rounded-2xl p-6 overflow-hidden
...
>
  ...
  <div className="relative z-10 h-full flex flex-col">
    ...
    {trend && (
      <div className={`mt-auto w- inline-flex items-center px-3 py-1.5 rounded-full text-xs font-medium 
        ...
        {trend >= 0 ? (
          ...
          <svg className="w-3 h-3 mr-1.5" fill="currentColor" viewBox="0 0 20 20">
            <path fillRule="evenodd" d="M12 13a1 1 0 01-1 1H9v-8a1 1 0 012 0v8h2a1 1 0 010 2H5a1 1 0 010-2h2V6a1 1 0 012 0v7h2a1 1 0 011 1z" clipRule="evenodd" />
          </svg>
        )}
        {Math.abs(trend)}%
      </div>
