...
function InvFundCard({ icon: Icon, product, capital, ROI, joinDate, endDate, badge , delay=300}) {
  ...
  `}
        ...
        >
            <div className='w-full relative bg-gradient-to-br from-gray-800 to-gray-900 p-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-700'>
                {/* Badge */}
