                ...
                <div className="flex items-center space-x-4">
                    ...
                    <div className="relative">
                        <button
                            ...
                            className="flex items-center space-x-2 text-xs bg-gradient-to-r from-gray-900 to-gray-800 text-white px-4 py-1 rounded-2xl hover:from-gray-800 hover:to-gray-700 transition-all duration-300 hover:scale-105 group"
                        >
