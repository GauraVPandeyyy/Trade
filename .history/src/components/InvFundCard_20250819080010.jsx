  ...
  `}
        ...
        >
            <div className='w-full relative bg-gradient-to-br from-gray-800 to-gray-900 p-5 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-700'>
                {/* Badge */}
                {planType.toLowerCase() !== "lifetime" ? (<div className='absolute -top-3 -right-3 bg-gradient-to-r from-yellow-400 to-yellow-500 text-gray-900 font-bold px-3 py-1 rounded-full text-sm'>
                    {plan}
                </div>
                ) : (<div className='absolute -top-3 -right-3 bg-gradient-to-r from-green-400 to-green-500 text-gray-900 font-bold px-3 py-1 rounded-full text-sm'>
                    Lifetime
                </div>
                )
                }
                ...
                <div className='flex items-center justify-center mb-4'>
                    ...
                    <h2 className='text-xl font-bold text-white'>Product <span></span> {product} (₹{invested})</h2>
                </div>
