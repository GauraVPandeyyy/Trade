...
const DashboardCard = ({ icon: Icon, label, value, colorClass = "text-blue-600", trend, delay = 0 }) => {
  ...
  return (
    <div 
      className={`
        group relative bg-white rounded-2xl p-5 shadow-sm border border-gray-100 
    ...
    >
      ...
      <div className="relative z-10 flex items-start justify-between">
        ...
        <div className={`
          p-2 rounded-2xl transition-all duration-500 group-hover:scale-110 group-hover:rotate-6
