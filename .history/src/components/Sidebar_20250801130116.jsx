...
const Sidebar = ({ isOpen, onClose, isMobile }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={`
        ${isMobile ? 'fixed' : 'sticky'} left-0 top-0 h-screen w-[270px] bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 
      ...
      `}>
        {/* Logo Section */}
        <div className="p-7 border-b border-gray-700/50 relative overflow-hidden">
        ...
        {/* Menu Items */}
        <nav className="mt-8 px-6 space-y-2.5">
          {menuItems.map((item, index) => (
            ...
            >
              ...
              >
                ...
                {item.badge && (
                  <span className={`
                    relative z-10 px-2 py-1 text-[5px] font-bold rounded-full
                    ${item.badge === 'New' 
