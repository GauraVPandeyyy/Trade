...
const DashboardCard = ({ icon: Icon, label, value, colorClass = "text-blue-600", trend, delay = 300 }) => {
  ...
  `}
    ...
    >
      ...
      <div className="absolute inset-0 opacity-60 group-hover:opacity-20 transition-opacity duration-700">
        <svg width="100%" height="100%" viewBox="0 0 256 256" preserveAspectRatio="none">
          <defs>
            <pattern id="diagonalHatch" patternUnits="userSpaceOnUse" width="10" height="10">
              <path d="M-1,1 l2,-2 M0,10 l10,-10 M9,11 l2,-2" stroke="#000" strokeWidth="0.9" />
            </pattern>
          </defs>
