    ...
    <>
      ...
      `}>
        ...
        {isMobile && (
          <button
            onClick={onClose}
            className="absolute top-2 right-2 p-3 text-gray-400 hover:text-white hover:bg-gray-800 hover:animate-bounce rounded-xl transition-all duration-300 z-10"
          >
            <X size={20} />
          </button>
        )}
