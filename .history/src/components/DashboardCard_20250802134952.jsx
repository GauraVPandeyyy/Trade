...
const DashboardCard = ({ icon: Icon, label, value, colorClass = "text-blue-600", trend, delay = 0 }) => {
  ...
  return (
    ...
    <div
      className={`
    relative h-auto border-t-3 rounded-t-xl rounded-5xl p-5 overflow-hidden
    bg-white 
    ...
    group
  `}
      style={{ transitionDelay: `${delay}ms`, borderImage: 'linear-gradient(to bottom right, #4ade80, #3b82f6) 1',
    borderImageSlice: 1,
    borderRadius : 20,
 }}
    >
