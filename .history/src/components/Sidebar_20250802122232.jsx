          ...
          {menuItems.map((item, index) => (
            ...
            >
              <button
                ...
                className={`
                  ...
                  ${activeItem === item.name 
                    ? 'bg-gradient-to-r from-blue-300 to-pink-400 text-white shadow-lg shadow-green-500/25' 
              ...
              >
                ...
                <div className={`
                  absolute inset-0 bg-gradient-to-r from-green-600/20 to-blue-600/20 border-l-4 border-l-green-800 rounded
