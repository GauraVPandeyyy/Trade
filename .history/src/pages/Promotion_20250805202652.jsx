...
function Promotion() {
  ...
  const promotionData = 
    {inviteCode : 'FUTURETRADE01' , inviteLink : 'https://web.futureservices.services/register?refcode=FUTURETRADE01' , productRocky : 8 , statusRocky : true , productFounder : 0 , statusFounder : false }
  ]
