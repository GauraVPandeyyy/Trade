...
const dashboardData = [
  ...
  { icon: DollarSign, label: "Team Income", value: homeData.cashback_income, color: "text-green-600" },
  ...
  { icon: Coins, label: "Daily Income", value: homeData.total_daily_income , color: "text-yellow-600" },
  { icon: PiggyBank, label: "Total Daily Income", value: total_daily_income , color: "text-green-600" },
