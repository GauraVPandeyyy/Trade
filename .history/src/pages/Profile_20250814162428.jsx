...
import { NavLink, useNavigate } from 'react-router-dom'; // NavLink import karein
      ...
      <div className="w-full max-w-4xl space-y-8">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
            <div><p className="text-sm text-gray-500">Login ID</p><p className="text-lg font-bold text-gray-800">{userData.loginId}</p></div>
            <div><p className="text-sm text-gray-500">Mobile No.</p><p className="text-lg font-bold text-gray-800">{userData.mobile}</p></div>
