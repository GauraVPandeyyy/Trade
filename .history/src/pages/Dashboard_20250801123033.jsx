      ...
      <div className={`flex-1 flex flex-col transition-all duration-500 ${!isMobile ? 'ml-0' : ''}`}>
        ...
        <main className="flex-1 p-6 space-y-8">
          ...
          <div className={`transform transition-all duration-700 ${statsVisible ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
            ...
            <div className="relative bg-gradient-to-r from-green-50 to-blue-50 border border-green-200/50 rounded-2xl p-3 mb-8 overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-r from-green-500/5 to-blue-500/5"></div>
              <div className="relative flex items-start space-x-4">
                <div className="w-10 h-12 bg-gradient-to-br from-green-500 to-blue-500 rounded-2xl flex items-center justify-center text-white shadow-lg">
                  <Gift size={24} />
                </div>
                <div className="flex-1">
