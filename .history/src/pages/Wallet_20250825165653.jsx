...
import { getInvestmentSummary, getWalletData } from '../services/apiService';
...
function Wallet() {
  ...
  return (
    ...
    <main className="flex-1 py-6 px-4 sm:px-6 lg:px-8 space-y-8">
      ...
      <Navbar expand="lg" className="bg-body-tertiary bg-amber-300">
        <Container>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="col-span-2 bg-gray-800 text-white p-5 rounded-xl shadow-md border-l-4 border-green-500">
          ...
          <div className='grid grid-cols-2 gap-4'>
            <button
              onClick={() => handleWithdraw(totals.capital, 'capital')}
            ...
            <button
              onClick={() => handleWithdraw(totals.roi, 'roi')}
              className="mt-4 w-full bg-green-500 hover:bg-green-600 text-white py-2 px-4 rounded-md font-medium shadow-md transition-colors duration-200"
            >
              Withdraw ROI
            </button>
        ...
        <div className="col-span-2 bg-gray-800 text-white p-5 rounded-xl shadow-md border-l-4 border-green-500">
          ...
          <div className='grid grid-cols-2 gap-4'>
            <button
              onClick={() => handleReInvest(totals.capital, 'capital')}
              className="mt-4 w-full bg-yellow-500 hover:bg-yellow-600 text-white py-2 px-4 rounded-md font-medium shadow-md transition-colors duration-200"
            >
              Re-Invest Capital
            </button>

            <button
              onClick={() => handleReInvest(totals.roi, 'roi')}
              className="mt-4 w-full bg-yellow-500 hover:bg-yellow-600 text-white py-2 px-4 rounded-md font-medium shadow-md transition-colors duration-200"
            >
              Re-Invest ROI
            </button>
          ...
          <div className="flex justify-between items-start">
            <div>
              ...
              <span className='font-bold text-xl text-white'>
                {formatCurrency(walletData.Deposite)}
              </span>
            </div>
      ...
      {/* Transaction History */}
      <NavLink to="/transaction-history" className={`transform transition-all duration-500 ${statsVisible ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
