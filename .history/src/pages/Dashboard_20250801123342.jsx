          ...
          <div className={`transform transition-all duration-700 ${statsVisible ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-gray-600 text-xs">Monitor your network growth and earnings</p>
              </div>
              <div className="flex items-center space-x-4">
            ...
            <div className="relative bg-gradient-to-r from-green-50 to-blue-50 border border-green-200/50 rounded-2xl text-sm p-3 mb-8 overflow-hidden">
