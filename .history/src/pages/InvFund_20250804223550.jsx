...
function InvFund() {
  ...
  const projectData = [
    ...
    { icon : Wallet,  product : 2 , capital : 10000 , ROI : 10, joinDate : "2025-01-01", endDate : "2025-05-05" , badge : 1/18 },
    { icon : Wallet,  product : 15 , capital : 10000 , ROI : 10, joinDate : "2025-01-01", endDate : "2025-05-05" , badge : 1/18 },
