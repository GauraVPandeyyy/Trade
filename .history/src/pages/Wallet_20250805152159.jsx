...
function Wallet() {
  ...
  return (
    <main className="flex-1 py-0 px-7 space-y-8">
      ...
      <div className={`transform transition-all duration-500 ${statsVisible ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
        <div className="flex justify-between items-center mb-6 border-t-2 border-t-gray-800 rounded-xl py-4 px-5 shadow-lg">
          <h2 className="text-lg font-semibold">
           Transaction History
          </h2>
          <div className='text-green-500 font-bold text-2xl' ><ChevronRight /></div>
