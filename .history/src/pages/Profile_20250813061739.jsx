...
const ProfileLink = ({ icon: Icon, text, href = "#" }) => (
  <NavLink to="team-tree" to="profile" className="flex items-center justify-between p-4 bg-gray-50 hover:bg-gray-100 rounded-xl transition-all duration-300 group">
...
function UserProfile() {
  ...
  const actionLinks = [
    { icon: Banknote, text: "Bank Details" },
