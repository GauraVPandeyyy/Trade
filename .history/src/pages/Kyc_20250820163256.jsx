...
import { submitKyc } from '.ser/apiService';
...
function Kyc() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Prepare data; adjust if backend expects FormData for file uploads
    const kycData = {
      user_id,
      adhar_card: aadhar_card,
      aadhaar_front: '', // Set base64 string or file as required
      aadhaar_back: '',
      pancard: panNum,
      pan_front: '',
    };
