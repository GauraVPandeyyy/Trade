...
const Dashboard = () => {
  ...
  const dashboardData = [
    ...
    { icon: DollarSign, label: "Team Income", value: "0", color: "text-green-600", trend: 0.0 },
    { icon: Receipt, label: "Total Payout", value: "108,028", color: "text-purple-600", trend: -2.1 },
    { icon: BarChart3, label: "Today Team Business", value: "0", color: "text-orange-600", trend: 0.1 },
