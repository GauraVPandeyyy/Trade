  ...
  return (
    <main className="flex-1 py-0 px-7 space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className='flex justify-between items-center bg-gray-800 text-white p-3 rounded-2xl border-t-4 border-t-green-500'>
          <div className='text-center'>
            <p>Deposits</p>
            <span className='fontbold'>₹ {walletData.deposit}
            </span>
          </div>
          <div>
            <CreditCard size={20} />
