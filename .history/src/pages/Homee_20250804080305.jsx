...
function Homee() {
  ...
  const dashboardData = [
    { icon: Users, label: "Active Downline", value: "135,614", color: "text-blue-600"d: 12.5 },
    { icon: DollarSign, label: "Team Income", value: "0", color: "text-green-600"d: 0 },
    { icon: Receipt, label: "Total Payout", value: "108,028", color: "text-purple-600"d: -2.1 },
    { icon: BarChart3, label: "Today Team Business", value: "0", color: "text-orange-600"d: 0 },
    { icon: Coins, label: "Daily Income", value: "₹423,387.10", color: "text-yellow-600"d: 8.3 },
    { icon: PiggyBank, label: "Total Daily Income", value: "₹16,368,515", color: "text-green-600"d: 15.7 },
    { icon: CreditCard, label: "Total Income", value: "₹11,989,014", color: "text-blue-600"d: 22.4 },
    { icon: Wallet, label: "Wallet Balance", value: "₹11,989,014", color: "text-indigo-600"d: 5.2 },
    { icon: Award, label: "Cashback Income", value: "₹964.00", color: "text-pink-600"d: 3.1 },
