          ...
          <div className={`transform transition-all duration-700 ${statsVisible ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex items-center">
                <select className="pl-2 pr-1 py-1 text-sm bg-white border border-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500">
            ...
            <div className="relative bg-gradient-to-r from-green-50 to-blue-50 border border-green-200/50 rounded-2xl text-sm p-2 mb-6 overflow-hidden">
              ...
              <div className="relative flex items-start space-x-3">
                ...
                <div className="flex-1">
                  <h3 className="text-lg font-semibold text-gray-900 ">Welcome to Future Trade</h3>
