...
function UserProfile() {
 ...
 const isNameChanged = updateName !== userData.name;
  const isPhotoChanged = tempImage !== null;
    ...
    try {
      const updateData = {
        ...
        name: updateName.name !== "" ? updateName.name : userData.name,   // agar empty hai toh blank
