...
function Homee() {
  ...
  const dashboardData = [
    { icon: Users, label: "Active Downline", value: "135,614", color: "text-blue-600"2.5 },
    { icon: DollarSign, label: "Team Income", value: "0", color: "text-green-600" },    { icon: Receipt, label: "Total Payout", value: "108,028", color: "text-purple-600"2.1 },
    { icon: BarChart3, label: "Today Team Business", value: "0", color: "text-orange-600" },
    { icon: Coins, label: "Daily Income", value: "₹423,387.10", color: "text-yellow-600".3 },
    { icon: PiggyBank, label: "Total Daily Income", value: "₹16,368,515", color: "text-green-600"5.7 },
    { icon: CreditCard, label: "Total Income", value: "₹11,989,014", color: "text-blue-600"2.4 },
    { icon: Wallet, label: "Wallet Balance", value: "₹11,989,014", color: "text-indigo-600".2 },
    { icon: Award, label: "Cashback Income", value: "₹964.00", color: "text-pink-600".1 },st [statsVisible, setStatsVisible] = useState(false);
