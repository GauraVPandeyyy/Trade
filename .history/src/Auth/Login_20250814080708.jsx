        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <div className="relative">
              <input name="mobile" type="text" placeholder="Enter your email or mobile" onChange={handleChange} className={`w-full px-4 py-3 mt-1 border rounded-lg focus:ring-2 transition-all ${errors.email ? 'border-red-500 focus:ring-red-300' : 'border-gray-300 focus:ring-blue-300 focus:border-blue-500'}`} />
