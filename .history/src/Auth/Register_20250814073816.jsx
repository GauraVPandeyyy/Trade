...
function Register() {
  ...
  const validate = () => {
    ...
    if (!formData.captcha_code) {
      newErrors.captcha_code = "CAPTCHA is required";
    } else if (formData.captcha_code !== captchaData) {
          ...
          <div className="flex items-center gap-4 pt-4 border-t">
            ...
            <div className="mt-7 flex items-center p-3 bg-gray-200 rounded-lg">
              ...
              <button
                ...
                className="ml-3 text-gray-600 hover:text-blue-600 transition-transform hover:rotate-180"
              >
                <RefreshCw size={18} />
              </button>
            </div>
