      ...
      >
        ...
        <div className="relative z-10">
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-5">
            ...
            {/* CAPTCHA Section */}
            <div className="space-y-2">
              <label className="text-sm font-medium text-white/80">CAPTCHA</label>
                ...
                <div className="relative flex-1 group">
                  ...
                  <div className="relative">
                    <input 
                      ...
                      onChange={handleChange} 
                      className={`w-full px-4 py-3 bg-white/5 backdrop-blur-sm text-white border border-white/10 rounded-lg focus:ring-2 focus:outline-none transition-all ${errors.captcha ? 'border-red-400/50 focus:ring-red-400/30' : 'focus:ring-indigo-500/30 focus:border-indigo-400/50'}`} 
                    />
                  </div>
                </div>
                <div className="mt-1 flex items-center p-3 bg-white/10 backdrop-blur-sm rounded-lg border border-white/10 shadow-sm">
                  ...
                  <button 
                    ...
                    className="ml-3 p-1 text-white/50 hover:text-indigo-300 transition-all hover:rotate-180 active:scale-90"
                  >
                    <RefreshCw size={18} />
                  </button>
                </div>
              </div>
              {errors.captcha && <p className="text-red-300 text-xs mt-1 animate-fade-in">{errors.captcha}</p>}
            </div>
