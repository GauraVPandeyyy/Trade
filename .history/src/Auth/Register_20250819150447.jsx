              ...
              return (
                <div key={field} className="w-full">
                  ...
                  <select
                    ...
                    className={`w-full px-4 py-3 bg-black border ${errors.state ? "border-red-400" : "border-white/20"} rounded-lg text-white focus:outline-none focus:ring-2 ${errors.state ? "focus:ring-red-400/50" : "focus:ring-teal-400/50"} transition-all`}
                    required
                  >
