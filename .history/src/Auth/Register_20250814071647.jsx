...
function Register() {
  ...
  const validate = () => {
    // Yahan aap har field ke liye detailed validation logic add kar sakte hain.
    // Example:
    const newErrors = {};
    ...
    if (formData.captcha_code !== captchaData) newErrors.captcha_code = "CAPTCHA does not match";
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center gap-4 pt-4 border-t">
            ...
            <div className="mt-7 flex items-center p-3 bg-gray-200 rounded-lg">
              <span className="text-xl font-bold tracking-widest select-none">{captcha}</span>
          ...
          <button type="submit" disabled={loading} className="w-full flex items-center justify-center gap-2 px-4 py-3 text-white bg-gradient-to-r from-green-500 to-teal-600 rounded-lg hover:from-green-600 hover:to-teal-700 transition-all shadow-lg focus:outline-none focus:ring-4 focus:ring-green-300 disabled:opacity-70">
